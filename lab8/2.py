...
def game_over() :
    ...
    game_over_surface = my_font.render(
        'Your Score and Level is : ' + str(score) + ',' + str(level), True, red)
...
while True :
    ...
    if not fruit_spawn :
        fruit_position = [random.randrange(1, (window_x // 10)) * 10,
                          random.randrange(1, (window_y // 10)) * 10]
        while fruit_position in snake_body or fruit_position[0] < 0 or fruit_position[0] > window_x - 10 or fruit_position[1] < 0 or fruit_position[1] > window_y - 10 :
            fruit_position = [random.randrange(1, (window_x // 10)) * 10,
                          random.randrange(1, (window_y // 10)) * 10]
